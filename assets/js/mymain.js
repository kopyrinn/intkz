...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const newsData = {
        1: {
            ...
            content: "<p>Новый завод расположен на территории специальной экономической зоны «НИНТ». Установленное здесь современное оборудование с программным управлением помогает контролировать, а при необходимости оперативно вносить изменения в процесс изготовления геотекстиля.</p><p>Для получения полиэфирного геосинтетического материала штапельное волокно попадает в специальный аппарат, вытяги­вается в тонкие волокна. Оттуда они подаются на станок с нес­колькими валами, где склеи­ваются между собой с помощью игольчатого устройства, то есть не ткутся, как другие ткани. Такое термоскрепление волокон с последующей прокаткой между горячими валами придает готовой продукции необходимую жесткость и прочность. У материала к тому же отличные дренирующие и фильтрационные свойства.– В последние годы нетканый геотекстиль – один самых популярных материалов в строительстве, благоустройстве и даже в сельском хозяйстве. Обычно он выполняет разделительную, укрепительную и защитную функции. Он надежен, долговечен, прост в применении, – рассказал генеральный директор ТОО «Интаго Казахстан» Азамат Асылбеков.Геотекстиль укладывают под дорожные покрытия, чтобы защитить асфальт от повреждений, используют для упрочнения фундаментов зданий, возведения дренажных систем, при создании искусственных водоемов. Полиэфирный геотекстиль также применяется при строительстве атомных станций – тут он помогает решать проблемы устойчивости почвы, дренажа, гидроизоляции, укрепления конструкций и защиты подземных коммуникаций.</p>",
